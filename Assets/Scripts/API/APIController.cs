...
namespace API
{
    ...
    public class APIController : MonoBehaviour
    {
        ...
        {
            StartCoroutine(PostUnlockVehicle());
        }
        ...
        {
            StartCoroutine(GetUnlockVehicle());
        }
        ...
        {
            StartCoroutine(PostLockVehicle());
        }

        [ContextMenu("TestLockCommandStatus")]
        void TestLockCommandStatus()
        {
            StartCoroutine(GetLockVehicle());
        }
