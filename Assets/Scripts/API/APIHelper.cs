...
namespace API
{
    ...
    public static class APIHelper
    {
        ...
        public const string CODE_TOKEN =
        ...
        {
            {
                UriType.GetAccessToken,
                "https://dah2vb2cprod.b2clogin.com/914d88b1-3523-4bf6-9be4-1b96b4f6f919/oauth2/v2.0/token?p=B2C_1A_signup_signin_common"
            },
            {
                UriType.GetRefreshToken,
                "https://dah2vb2cprod.b2clogin.com/914d88b1-3523-4bf6-9be4-1b96b4f6f919/oauth2/v2.0/token?p=B2C_1A_signup_signin_common"
            },
            {UriType.GetVehicleList, "https://api.mps.ford.com/api/fordconnect/vehicles/v1"},
            {
                UriType.PostUnlockVehicle,
                "https://api.mps.ford.com/api/fordconnect/vehicles/v1/8a7f9fa878849d8a0179579d2f26043a/unlock"
            },
            {
                UriType.GetUnlockVehicle,
                "https://api.mps.ford.com/api/fordconnect/vehicles/v1/8a7f9fa878849d8a0179579d2f26043a/unlock/"
            },
            {
                UriType.PostLockVehicle,
                "https://api.mps.ford.com/api/fordconnect/vehicles/v1/8a7f9fa878849d8a0179579d2f26043a/lock"
            },
            {
                UriType.GetLockVehicle,
                "https://api.mps.ford.com/api/fordconnect/vehicles/v1/8a7f9fa878849d8a0179579d2f26043a/lock/"
            },
            {
                UriType.PostStartEngine,
                "https://api.mps.ford.com/api/fordconnect/vehicles/v1/8a7f9fa878849d8a0179579d2f26043a/startEngine"
            },
            {
                UriType.GetStartEngine,
                "https://api.mps.ford.com/api/fordconnect/vehicles/v1/8a7f9fa878849d8a0179579d2f26043a/startEngine/"
            },
            {
                UriType.PostStopEngine,
                "https://api.mps.ford.com/api/fordconnect/vehicles/v1/8a7f9fa878849d8a0179579d2f26043a/stopEngine"
            },
            {
                UriType.GetStopEngine,
                "https://api.mps.ford.com/api/fordconnect/vehicles/v1/8a7f9fa878849d8a0179579d2f26043a/stopEngine/"
            },
            {
                UriType.PostWake,
                "https://api.mps.ford.com/api/fordconnect/vehicles/v1/8a7f9fa878849d8a0179579d2f26043a/wake"
            },
            {
                UriType.PostVehicleStatus,
                "https://api.mps.ford.com/api/fordconnect/vehicles/v1/8a7f9fa878849d8a0179579d2f26043a/status"
            },
            {
                UriType.GetVehicleStatus,
                "https://api.mps.ford.com/api/fordconnect/vehicles/v1/8a7f9fa878849d8a0179579d2f26043a/statusrefresh/"
            },
            {
                UriType.GetVehicleInformation,
                "https://api.mps.ford.com/api/fordconnect/vehicles/v1/8a7f9fa878849d8a0179579d2f26043a"
            },
            {
                UriType.PostVehicleLocation,
                "https://api.mps.ford.com/api/fordconnect/vehicles/v1/8a7f9fa878849d8a0179579d2f26043a/location"
            },
            {
                UriType.GetVehicleLocation,
                "https://api.mps.ford.com/api/fordconnect/vehicles/v1/8a7f9fa878849d8a0179579d2f26043a/location"
            },
            {
                UriType.GetVehicleThumbnail,
                "https://api.mps.ford.com/api/fordconnect/vehicles/v1/8a7f9fa878849d8a0179579d2f26043a/images/thumbnail?make=Ford&model=&year=2019"
            },
        };
